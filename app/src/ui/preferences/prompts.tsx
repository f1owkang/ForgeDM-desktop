...
> {
  ...
  private renderSwitchBranchOptionLabel = (key: UncommittedChangesStrategy) => {
    switch (key) {
      ...
      case UncommittedChangesStrategy.MoveToNewBranch:
        return t('preferences.prompts.switchBranch.moveToNewBranch')
      case UncommittedChangesStrategy.StashOnCurrentBranch:
        return t('preferences.prompts.switchBranch.stashOnCurrentBranch')
      default:
    ...
    return (
      <div className="advanced-section">
        <h2 id="switch-branch-heading">
          {t('preferences.prompts.switchBranch.heading')}
        </h2>
  ...
  private renderCommittingFilteredChangesPrompt = () => {
    return (
      <Checkbox
        label={t('preferences.prompts.confirm.commitFilteredChanges')}
        value={
      ...
      <DialogContent>
        <div className="advanced-section">
          ...
          <div role="group" aria-labelledby="show-confirm-dialog-heading">
            <Checkbox
              label={t('preferences.prompts.confirm.repositoryRemoval')}
              value={
            ...
            />
            <Checkbox
              label={t('preferences.prompts.confirm.discardChanges')}
              value={
            ...
            />
            <Checkbox
              label={t('preferences.prompts.confirm.discardChangesPermanently')}
              value={
            ...
            />
            <Checkbox
              label={t('preferences.prompts.confirm.discardStash')}
              value={
            ...
            />
            <Checkbox
              label={t('preferences.prompts.confirm.checkoutCommit')}
              value={
            ...
            />
            <Checkbox
              label={t('preferences.prompts.confirm.forcePush')}
              value={
            ...
            />
            <Checkbox
              label={t('preferences.prompts.confirm.commitMessageOverride')}
              value={
            ...
            />
            <Checkbox
              label={t('preferences.prompts.confirm.worktreeRemoval')}
              value={
