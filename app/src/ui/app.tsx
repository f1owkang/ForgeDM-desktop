...
export class App extends React.Component<IAppProps, IAppState> {
      ...
      case PopupType.Preferences:
        ...
        return (
          <Preferences
            ...
            selectedLanguagePreference={this.state.selectedLanguagePreference}
  ...
  private renderRepositoryToolbarButton() {
    ...
    if (repository) {
      ...
      icon = octicons.repo
      title = platformT('dialogs.app.selectRepository')
    } else {
      icon = octicons.repo
      title = platformT('dialogs.app.noRepositories')
    }
    ...
    return (
      <ToolbarDropdown
        icon={icon}
        title={title}
        description={platformT('dialogs.app.currentRepository')}
        tooltip={tooltip}
