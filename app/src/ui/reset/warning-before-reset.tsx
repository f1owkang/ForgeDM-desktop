...
> {
  ...
  public render() {
    const title = platformT('dialogs.warningBeforeReset.title')
      ...
      >
        <DialogContent>
          <Row id="reset-warning-message">
            {t('dialogs.warningBeforeReset.message')}
          </Row>
        </DialogContent>
        <DialogFooter>
          <OkCancelButtonGroup destructive={true} okButtonText={t('dialogs.warningBeforeReset.continue')} />
        </DialogFooter>
      </Dialog>
    )
  }
